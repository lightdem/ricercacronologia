...
# -*- coding: utf-8 -*-
##############################################################################
# file: cronologia7.py (progetto cronologia comandi)
#
#           Un programma utility scritto in PyQt5 che esamina
#           e ricerca all'interno del file .bash_history.
# author:   Linux Pro Staff
#
# last revision:	10/02/2019
##############################################################################
...
"Alfabetico"))
    ...
    def istruzioni(self, nomeProgramma):    # Stampa le istruzioni ed esce
        sArrayNome = nomeProgramma.rsplit('/', 1)
        print('\n' + sArrayNome[1] + ': utility per la ricerca nella cronologia dei comandi')
        print('\t-h | --help\t\tmostra questo elenco')
        print('\t-v | --version\t\tmostra le informazioni sulla versione')
        print('\t\'criterio di ricerca\'\t\tricerca per \'criterio di ricerca\' nella cronologia comandi')
        print('\tsenza argomenti\t\tmostra/ricerca nella cronologia dei comandi\n\n')
        sys.exit(0)
        
    def versione(self, nomeProgramma):    # mostra le informazioni di versione ed esce
        sArrayNome = nomeProgramma.rsplit('/', 1)
        print('\n' + sArrayNome[1] + ': utility per la ricerca nella cronologia dei comandi')
        print('\tversione: ' + VERSION_NUMBER + 
